<div id="ddblueblockmenu">
                    <ul>
                        <li style="list-style: none"><a href="template.php">&nbsp; Inicio</a></li>
                                ...
                                <div class="menutitle">Suplencias</div>
                                <ul>                                   
                                     ...
                                     <li style="list-style: none"><a href="template.php?ind=<?php echo md5('listado_solicitudes'); ?>">&nbsp;<img src="images/vineta-peq.jpg">&nbsp;Listado de Solicitudes</a></li>                                     
                                </ul>
                                <div class="menutitle">Devoluciones</div>
                                <ul>                                   
                                              
                                     <li style="list-style: none"><a href="template.php?ind=<?php echo md5('devolucion_solicitud'); ?>">&nbsp;<img src="images/vineta-peq.jpg">&nbsp;Solicitudes Devueltas</a></li>
                                     <li style="list-style: none"><a href="template.php?ind=<?php echo md5('devolucion_solicitud'); ?>">&nbsp;<img src="images/vineta-peq.jpg">&nbsp;Continuar Solicitud Devuelta</a></li>                      
                                </ul>
