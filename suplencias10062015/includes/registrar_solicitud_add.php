...
//REGISTRAR NUEVA SOLICITUD
                    pg_query ($link, "INSERT INTO solicitud(
                                ...
                                usuario_dependencia_id, clasificacion_id, rol_aprobacion_id, estatus_solicitud, audit_usu_id, audit_ip, audit_dep_id, n_educativo, area_especialidad, experiencia, habilidades, cursos)
                        VALUES ( '".fecha_usa($_POST['fecha_inicio'])."', '".fecha_usa($_POST['fecha_fin'])."', 
                                ...
                                '".$_POST['n_educativo']."', '".$_POST['a_especialidad']."', '".$_POST['experiencia']."',
                                 '".$_POST['habilidades']."', '".$_POST['cursos']."')");
