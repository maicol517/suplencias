...
?>
<form id="form1" class="prueba" name="form1" method="post" action="includes/update_solicitud.php">
      ...
      ?></p>
        ...
        <tr>
          <td colspan="4"><h2>DATOS DE LA SOLICITUD
            <input name="id_solicitud" type="hidden" id="id_solicitud" value="<?= $ver->id?>" />
          </h2></td>
        </tr>
            <tr>
      <td>&nbsp;</td>
...
where estatus='t' 
 order by id asc"); 
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">Periodo de la Suplencia:&nbsp;Desde&nbsp;&nbsp;
            <input name="fecha_inicio" type="text" class="fecha" id="fecha_inicio" size="10" required="required" value="<?= fecha_venezuela($ver->fecha_incio); ?>" onchange="desbloquear_fecha()"/>
            <img src="images/ico_calendario.jpg" width="18" height="19" />&nbsp;&nbsp;Hasta&nbsp;&nbsp;<input name="fecha_fin" type="text" class="fecha" id="fecha_fin" size="10"  required="required" value="<?= fecha_venezuela($ver->fecha_fin); ?>"  disabled="disabled" onchange="contar_dias()"/>
    ...
    <tr>
      ...
      <td colspan="2"><select style="width:25%" class="campotexto" name="nacionalidad_c" id="nacionalidad_c" disabled="disabled" >
        ...
        <input name="cedula" type="text" class="campotexto" id="cedula" style="width:73%" value="<?= $ver->t_cedula; ?>" size="25" required="required" onblur="obten_datos()"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Nombre</td>
...
where estatus='t' 
 order by id asc"); 
    ...
    <tr>
      ...
      <td>Dependencia</td>
      <td colspan="2">
      <input name="dependencia_p" type="text"  class="campotexto" id="dependencia_p" value="<?= $ver->s_descripcion; ?>" readonly="readonly" required="required" /></td></tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="3" align="center" style="padding-top:4px"><input class="bottonsumit" type="submit" name="button" id="button" value="Modificar" /></td></tr>
     <tr  >
...
?>
<table width="95%" border="0" cellspacing="1" class="tabla_proveedor_consulta">
  <?php
		$color=0; $total=0;
